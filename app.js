...
//  TODO: Tambahkan variabel DB yang berasal dari file /config/Config
 mongoose.connect(DB: process.env.HOST ? process.env.HOST : 'mongodb+srv://andrian:11111@cluster0.wwdkr.mongodb.net/learnit-react.library?retryWrites=true&w=majority', {
...
app.listen(APP_PORT: process.env.PORT? process.env.PORT:80,);
